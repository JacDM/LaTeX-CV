    ...
    \begin{tcolorbox}
        ...
        \begin{minipage}[t]{0.28\textwidth} % Side Panel (e.g. Skills, Links, Languages, etc.)
            \begin{tcolorbox}[height=.83\textheight, grow to left by=0.6cm,colback=backdrop,colframe=backdrop,arc=2mm]
                ...
                \subsection*{Technical Skills}
                    ...
                    \href{https://github.com/JacDM/LaTeX-CV}{Code Repository}
            \end{tcolorbox}
        \end{minipage}
        \begin{minipage}[t]{0.75\textwidth} % Main Panel (e.g. Education, Work Experience)
            \begin{tcolorbox}[grow to right by=0.75cm,height=0.8\textheight,colframe=white,colback=white]
                ...
                \vspace{-1em} 
                I've had a long history of dabbling with electronics, 
                including Raspberry Pis and Linux PCs, and I've grown 
                passionate about understanding how computers operate. 
                Additionally, I've grown passionate about programming 
                and creating code in languages like Python and Java. 
                I like learning more about technology and how it functions
                at its core.
                %\SimpleSeparator{\ColorTextMain}
                % Work Experience
                \vspace{-2em}
                \section*{Projects}
                \vspace{-1em}
                    \work{Group Software Development Project}{October 2022 - March 2023}{\includegraphics[align=c, width=2em]{setup/pics/globe.png} Year 3@Heriot-Watt}{
                        • My team and I spent six months developing GeoTagAR to give users from around the world a method to interact and share AR-based content.\\
                        • My responsibilities included creating the application's front end and back end utilizing the AR- Core framework for AR and Flutter for the front end. I was also appointed team captain and scrum master. \\ 
                ...
                \section*{Education}
                \vspace{-1em}
                    \education{BSc(Hons) Computer Science}{September 2021 - May 2024}{%\includegraphics[align=c, width=2em]{setup/pics/HW.png} 
                    ...
                    \education{International Advanced Level}{September 2019 - May 2021}{%\includegraphics[align=c, width=1.5em]{setup/pics/RAK.jpeg} 
                    RAK Academy}{
                        ...
                        \education{IGCSE}{September 2017 - May 2019}{%\includegraphics[align=c, width=1.5em]{setup/pics/RAK.jpeg}
                         RAK Academy}{
                            \Label{}{Edexcel Mathematics - A*}
                            \Label{}{CIE Computer Science - A}
